export default class JsonHPack {
     ...
     */
    public static hPack(collection: Array<{ [key: string]: any }>, compression: number = 0): Array<Array<any>> {
     ...
     */
    public static hUnpack(collection: Array<Array<any>>) {
     ...
     */
    public static hClone(collection: Array<Array<any>>) {
     ...
     */
    public static hBest(collection: Array<{ [key: string]: any }>) {
        let j = 0;
