...
export default class PrefabCodeBuilderConst {
    /**
     * 预制路径
     */
     ...
     * UI路径
     */
    public static readonly UI_PATH = PrefabCodeBuilderConst.PREFAB_PATH + '/UI';
    /**
     * 输出文件根目录
     */
     ...
     * UI脚本路径
     */
    public static readonly UI_SCRIPT_PATH = PrefabCodeBuilderConst.ROOT_EXPORT_PATH + '/UI';
    /**
     * 扩展路径
     */
     ...
     * 该插件的临时文件路径
     */
    public static readonly TEMP_DATA_PATH = PrefabCodeBuilderConst.TEMP_PATH + '/fy-framework-tools';
    /**
     * 该插件的临时文件
     */
    public static readonly TEMP_DATA_FILE = PrefabCodeBuilderConst.TEMP_DATA_PATH + '/asset-change-flag.json';
